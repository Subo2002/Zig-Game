...
pub fn build(b: *std.Build) void {
    ...
    exe_mod.addImport("Zig_Game_lib", lib_mod);

    const zgpu = b.dependency("zgpu", .{
        .target = target,
    });
    exe_mod.addImport("zgpu", zgpu.module("root"));
    exe_mod.linkLibrary(zgpu.artifact("zdawn"));
    ...
    //not sure what this is about (just took it from the git for zglfw, doesn't work without it)
